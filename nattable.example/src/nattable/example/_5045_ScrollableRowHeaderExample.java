...
public class _5045_ScrollableRowHeaderExample  {
    ...
    public static void main(String[] args) throws Exception {
		...
		_5045_ScrollableRowHeaderExample dme = new _5045_ScrollableRowHeaderExample();
		dme.createExampleControl(shell);
    ...
    public Control createExampleControl(Composite parent) {
        ...
        IDataProvider bodyDataProvider =
                new ListDataProvider<>(PersonService.getPersons(100), columnPropertyAccessor);
        ...
        DataLayer rowDataLayer = new DataLayer(new IDataProvider() {
            ...
            public Object getDataValue(int columnIndex, int rowIndex) {
                return String.valueOf(rowIndex) + ": Lorem ipsum dolor Lorem ipsum dolor Lorem ipsum dolor Lorem ipsum dolor";
            }
...
/*
        ...
        compositeLayer.setChildLayer(GridRegion.ROW_HEADER, scrollableRowHeaderLayer, 0, 0);
        ...
        createSplitSliders(composite, rowViewport, 1 /*rowHeaderLayer.getWidth()*/, viewportLayer);
