...
public class _4222_CellPainterExample {
	...
	public static void main(String[] args) throws Exception {
		...
		_4222_CellPainterExample cpe = new _4222_CellPainterExample();
		cpe.createExampleControl(shell);
            ...
            return new DisplayConverter() {
                ...
                public Object canonicalToDisplayValue(Object canonicalValue) {
                    if (canonicalValue instanceof Person.Gender) {
                        return ((Person.Gender) canonicalValue) == Person.Gender.MALE;
                    }
                    return null;
                }
                ...
                public Object displayToCanonicalValue(Object displayValue) {
                    ...
                    return displayBoolean ? Person.Gender.MALE : Person.Gender.FEMALE;
                }
