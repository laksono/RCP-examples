...
import nattable.example.Person.Gender;
...
public class DarkExample 
{
    ...
    private IGroupBySummaryProvider sumMoneySummaryProvider;
    private IGroupBySummaryProvider avgMoneySummaryProvider;
    ...
    public void postConstruct(Composite parent) {
        ...
        rowHeaderDataLayer.setConfigLabelAccumulator(new AbstractOverrider() {
            ...
            @Override
            public Collection getProvidedLabels() {
                // make the custom labels available for the CSS engine
                Collection result = super.getProvidedLabels();
