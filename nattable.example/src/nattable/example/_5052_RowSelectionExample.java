 ...
 */
public class _5052_RowSelectionExample implements ILayerListener {
    ...
    public static void main(String[] args) throws Exception {
		...
		_5052_RowSelectionExample t = new _5052_RowSelectionExample();
	...
	public void handleLayerEvent(ILayerEvent event) {
		if (event instanceof RowSelectionEvent) {
			RowSelectionEvent e = (RowSelectionEvent) event;
			System.out.println("position " + e.getRowPositionToMoveIntoViewport() + "\n" + 
					 		   "ranges: "  + e.getRowPositionRanges() + "\n" + 
							   "indexes: " + e.getRowIndexes());
		}
	}
}
